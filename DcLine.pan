...
Save1 control begin
    ...
    save( "mat5", "dcLineAc.mat", "freq", Freq, "Yaa_0", Yaa_0, \
                                               "Yba_0", Yba_0);
 
endcontrol

Alt2A alter instance=Ex param="pacmag" value=1 invalidate=no
PDc  pac start=100m stop=7*F0 dec=1000 parsolver=1
Alt2B alter instance=Ex param="pacmag" value=0 invalidate=no
...
Save2 control begin
    ...
    save( "mat5", "dcLineDc.mat", "freq", Freq, "Ypp_0", Ypp_0);
...
CfC1p   BmA1_pos  gnd       vsource dc= VDC_NOM/2
CfC1n   BmA1_neg   gnd       vsource dc=-VDC_NOM/2
