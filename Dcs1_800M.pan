...
parameters TCROSS=10n TRISE=1u TSTOP=4                 // DURATION OF SIMULATION
...
Sh shooting fund=F0 restart=no floquet=yes tmin=1n method=2 maxord=2 \
            iabstol=10u sparse=1 solver=1 tmax=0.1m acntrl=3

AltA alter instance=Ex param="pacmag" value=1 invalidate=no
PDc  pac start=100m stop=7*F0 dec=1000 parsolver=1
AltB alter instance=Ex param="pacmag" value=0 invalidate=no
...
Save control begin
    ...
    save( "mat5", "Dcs1_800M.mat", "freq", Freq, "Ypp_0", Ypp_0);
