...
Save1 control begin
    ...
    save( "mat5", "dcInfAc.mat", "freq", Freq, "Yaa_0", Yaa_0, \
                                               "Yba_0", Yba_0, \
					       "Ypa_0", Ypa_0 );
 
    Freq        = get("PAc@2.freq");
    Ypa_2       = get("PAc@2.Ex:i");

    save( "mat5", "dcInfAc2.mat", "freq", Freq, "Ypa_2", Ypa_2);
...
Save2 control begin
    ...
    save( "mat5", "dcInfDc.mat", "freq", Freq, "Ypp_0", Ypp_0);
